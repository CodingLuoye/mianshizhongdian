...
//           A,B,C,D,E
    ...
    public static void main(String[] args){
        ...
        list1.add("B");
        list1.add("C");
        String result1 = Trains.getRoute(list1);//Test1
        System.out.println(result1);

        List<String> list2 = new ArrayList<String>();
        list2.add("A");
        list2.add("D");
        String result2 = Trains.getRoute(list2);//Test2
        ...
        list3.add("D");
        list3.add("C");
        String result3 = Trains.getRoute(list3);//Test3
        ...
        list4.add("C");
        list4.add("D");
        String result4 = Trains.getRoute(list4);//Test4
        ...
        list5.add("E");
        list5.add("D");
        String result5 = Trains.getRoute(list5);//Test5
        System.out.println(result5);

        List<String> list6 = new ArrayList<>();
        List<String> pathList6 = Trains.cTocLessThen("C", "C", 3, list6);//Test6
        System.out.println(pathList6.size());

        int result7 = Trains.aTocWith("A", "C", 4);//Test7
        System.out.println(result7);

        int result8 = Trains.aTocShorted("A", "C", 0);//Test8
        System.out.println(result8);

        int result9 = Trains.aTocShorted("B", "B", 0);//Test9
        System.out.println(result9);

        List<String> list10 = new ArrayList<>();
        List<String> pathList10 = Trains.cTocValLessThen("C", "C", 0,list10);//Test10
